...
| 4 | Ordinary-time occasion names: RCL "Proper 22 (27)" or "Nineteenth Sunday after Pentecost"? | RCL designation (editable) | 2c | [2](2026-09-25-slice-2-readings-design.md) |
...
| 7 | When the first reading isn't from the OT (Acts in Easter), what prints under "Old Testament Reading"? | Parity: the first reading | 5a | [5a](2026-09-25-slice-5a-documents-archive-design.md) |
