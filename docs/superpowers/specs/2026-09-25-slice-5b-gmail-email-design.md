...
| Settings sections Church, Hymns, Liturgy, Prayers, Rubric, Contacts (Prayers and Rubric per the 6a amendment of 2026-09-26); narrowing the "still in the current app" note | 6a (added to the layout built here) |
...
| 6b (hand-off) | Inserts People before Account and appends Danger zone. Final `SETTINGS_SECTIONS` order: **Church, Hymns, Liturgy, Prayers, Rubric, Contacts, People, Account, Danger zone** (as the 6a amendment of 2026-09-26 lists it: Prayers, PR #7, and Rubric, PR #4, sit after Liturgy). Removes the `LegacySettingsNote`. |
...
- 5b ships one section: `{id: "account", href: "/settings/account", label: "Account"}`. `/settings` redirects (`router.replace`) to `SETTINGS_SECTIONS[0].href`. The final order after 6a and 6b is Church, Hymns, Liturgy, Prayers, Rubric, Contacts, People, Account, Danger zone.
