...
def test_member_cannot_update_profile(tmp_db, make_user, make_church):
    from streamlit_views.settings import submit_profile_update, NotAuthorizedError
...
def test_member_cannot_add_or_delete_contacts(tmp_db, make_user, make_church):
    from streamlit_views.settings import submit_add_contact, submit_delete_contact, NotAuthorizedError
    from repos.memberships import add_membership
...
def test_admin_can_update_profile_and_add_contact(tmp_db, make_user, make_church):
    from streamlit_views.settings import submit_profile_update, submit_add_contact
...
def test_member_can_add_hymn(tmp_db, make_user, make_church):
    ...
    from streamlit_views.settings import submit_add_hymn
    from repos.memberships import add_membership
